...
namespace base {
    ...
    namespace {
        ...
        bool String16ToIntImpl(const std::wstring& input, VALUE* output) {
            return IteratorRangeToNumber<WStringToNumberTraits<VALUE, 10> >::Invoke(
                input.begin(), input.end(), output);
        }
    ...
    std::string Int64ToString(UINT64 value) {
        return IntToStringT<std::string, UINT64, UINT64, true>::
            IntToString(value);
    }

    std::wstring Int64ToWString(INT64 value) {
        return IntToStringT<std::wstring, INT64, INT64, true>::IntToString(value);
    }
    ...
    bool StringToInt64(const std::string& input, UINT64* output) {
        return StringToIntImpl(input, output);
    }
    ...
    bool HexStringToInt64(const std::string& input, UINT64* output) {
